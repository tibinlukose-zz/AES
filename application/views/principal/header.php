            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li data-toggle="modal" data-target="#myProfile"><a href="#"><i class="fa fa-user fa-fw"></i>Edit Profile | <?php echo $this->session->userdata('name');?></a>
                        </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url($this->uri->segment(1));?> "><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Departments<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                        <a href="<?php echo base_url($this->uri->segment(1)."/page/department");?> ">Manage Departments</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url($this->uri->segment(1)."/page/createHOD");?> ">Create HOD</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url($this->uri->segment(1)."/page/createDepartment");?>">Create Departments</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                        <a href="<?php echo base_url($this->uri->segment(1)."/page/mainCourses");?> ">Create Courses</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url($this->uri->segment(1)."/page/manageCourses");?> ">Manage Courses</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                        <a href="<?php echo base_url($this->uri->segment(1)."/page/officeStaff");?> ">Manage Office Staff</a>
                                </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-edit fa-fw"></i>Academic Year & Semester<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li><a href="<?php echo base_url($this->uri->segment(1)."/page/ManageYear");?>">Manage Year</a>
                                <li><a href="<?php echo base_url($this->uri->segment(1)."/page/manageSemester");?>">Manage Semester</a>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url('principal/page/viewExamMark');?>">View Marks</a>
                                </li>
