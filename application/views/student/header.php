                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url('student/page/viewProfile');?>">View Profile</a>
                                </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i>Marks / Results<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                    <li>
                                        <a href="<?php echo base_url('student/page/viewExams');?>"><i class="fa fa-table fa-fw"></i>View Exams</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url('student/page/viewMarks');?>"><i class="fa fa-edit fa-fw"></i>View Marks</a>
                                    </li>
                                     <li>
                                        <a href="<?php echo base_url('student/page/viewUniversity');?>"><i class="fa fa-edit fa-fw"></i>View University Results</a>
                                    </li>
                            </ul>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i>E-Library<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                    <li>
                                        <a href="<?php echo base_url('student/page/viewEbooks');?>"><i class="fa fa-table fa-fw"></i>View E-Books</a>
                                    </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                    <li>
                                        <a href="<?php echo base_url('student/page/viewAttendance');?>"><i class="fa fa-table fa-fw"></i>View Attendance</a>
                                    </li>
